<?php
	...
	if(isset($_SESSION['fbadmin']))
	{
		...
		$que_admin_info=mysqli_query($con,"select * from admin_info where Username='$admin_user'");
...
<?php
	if(isset($_POST['change_password']))
	{
		...
		{
			mysqli_query($con,"update admin_info set Password='$new_password' where Username='$admin_user'");
		}
		else
		{
