...
if(isset($_POST['Login']))
{
	...
	// $que_admin_check=mysqli_select_db($user,$pass);
...
<!--head background-->
	...
	<!--text: faceback -->
	<div style="position:absolute;left:36%; top:3.3%; font-size:45; font-weight:900; color:#FFFFFF; font-weight:bold; box-shadow:0px -10px 20px 1px rgb(0,0,0);"> <font face="myFbFont"> faceback Admin </font> </div>
	<!--body background-->
