...
<table cellspacing="0">
<?php
	$que_post=mysqli_query($con,"select * from user_post where user_id=$v_user_id order by post_id desc");
...
<?php 
	...
	<tr style="color:#6D84C4;">
		<td >   </td>
		<?php
		 	$que_status=mysqli_query($con,"select * from user_post_status where post_id=$postid and user_id=$v_user_id;");
