<?php
	...
	if(isset($_SESSION['fbadmin']))
	{
		...
		$query1=mysqli_query($con,"select * from users where user_id=$v_user_id");
...
<?php
	...
	if(isset($_POST['contact_sub']))
	{
		...
		$u_web=$_POST['web'];
		$u_fb_id=$_POST['fbid'];
		mysqli_query($con,"update user_info set mobile_no='$u_m_no',mobile_no_priority='$u_priority',website='$u_web',Facebook_ID='$u_fb_id' where user_id=$userid;");
	}
...
<div style="position:absolute;left:53%; top:175%; font-size:18px; color:#89919C;">Faceback ID </div>
