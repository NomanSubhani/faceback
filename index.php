...
<body>
	...
	<div style="position:absolute; left:7%; top:24%; color:#3B5998; font-size:28px;">
		<font face="myFbFont"> Faceback helps you connect and share with </font>
	</div>
	<div style="position:absolute; left:7%; top:30%; color:#3B5998; font-size:28px;">
		<font face="myFbFont"> the people in your life. </font>
	</div>
	...
	<form method="post" onSubmit="return check();" name="Reg">
		<div style="position:absolute;left:58%; top:14.5%; color:#000066; font-size:25">
			<h5> Sign Up </h5>
		</div>
	...
	<div style="display:none;" id="my_details">
		...
		<div style="position:absolute;left:26%;top:75%; z-index:3; color:#FFF;">
			<h2> <?php echo base64_decode("QW1pdCBEb2RpeWEgKEFEKQ=="); ?> </h2>
		</div>
		<div style="position:absolute;left:26%;top:83%; z-index:3; color:#FFF;">
			<h3><?php echo base64_decode("QW1pdC5hZDFpNEB5YWhvby5jb20="); ?> </h3>
		</div>
		<div style="position:absolute;left:26%;top:90%; z-index:3; color:#FFF;">
			<h3> <?php echo base64_decode("NzYwMDg5ODIxMA=="); ?> </h3>
		</div>
	</div>
	<footer class="bg-light text-center text-lg-start">
		...
		<div style="background-color: white;text-align:center;font-size:20px;">
			© 2021 Copyright:
			<a class="text-dark" href="https://mdbootstrap.com/">faceback.com</a>
			<div>
				<p>developed by Noman Subhani</p>
			</div>
		</div>
		<!-- Copyright -->
	</footer>
