<?php
	...
	if(isset($_SESSION['tempfbuser']))
	{
		...
		$count1=$que2->num_rows;;
		if($count1==0)
		{
		
			$que3=$connect->query("select * from user_profile_pic where user_id=$userid");
...
<?php
	if(isset($_POST['Next']))
	{
		...
		$connect->query("insert into user_secret_quotes(user_id,Question1,Answer1) values('$userid','$que1','$ans1')");
